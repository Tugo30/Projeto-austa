        ...
        <div class="row justify-content-center">
            <div class="col-6">
                ...
                <div class="card border-1 border-danger p-5 text-center">
                    Se pretender remover a sua conta de usuário de forma permanent, escreva o texto "ELIMINAR" e clique
                    no botão abaixo.


                    <form action="{{ route('deleted_account') }}" method="POST">

                        @csrf

                        <div class="my-3">
                            <input class="form-control text-center" type="text" name="deleted_confirmation">
                            @error('deleted_confirmation')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
